...
public class Gui {
	...
	public void powerChop() {
		...
		final JComboBox<PowerEnum> box = new JComboBox<PowerEnum>(PowerEnum.values());
		...
		bottom.add(new JButton(new AbstractAction("Start!") {
			...
			public void actionPerformed(ActionEvent e) {
				choice = (PowerEnum) box.getSelectedItem();
				PowerEnum i = (PowerEnum) choice;
